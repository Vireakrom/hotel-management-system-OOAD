    ...
    public partial class LoginForm : Form
    {
        ...
        private void LoadSavedCredentials()
        {
            try
            {
                ...
                if (settings.RememberMe)
                {
                    ...
                    {
                        byte[] decoded = Convert.FromBase64String(settings.SavedPassword);
                        txtPassword.Text = Encoding.UTF8.GetString(decoded);
                    }
            ...
            {
                // If loading fails, just start with empty fields
            }
        }
        ...
        private void SaveCredentials()
        {
            ...
            if (chkRememberMe.Checked)
            {
                ...
                settings.SavedPassword = Convert.ToBase64String(
